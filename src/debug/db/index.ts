...
export function addCreatedAccount(address: string, account: WrappedEVMAccount) {
  let accountId
...
export function loadStatesFromJson(fileName: string): void {
  ...
  const beforeStates: jsonState[] = data.beforeStateAccounts
