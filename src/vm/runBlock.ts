 ...
 */
export function encodeReceipt(tx: TypedTransaction, receipt: TxReceipt): Buffer {
...
async function _applyDAOHardfork(state: StateManager): Promise<void> {
 ...
 */
export async function generateTxReceipt(this: VM, tx: TypedTransaction, txRes: RunTxResult, blockGasUsed: BN): Promise<{
  ...
  let txReceipt: PreByzantiumTxReceipt | PostByzantiumTxReceipt
