 ...
 */
export function accessAddressEIP2929(runState: RunState, address: Address, common: Common, chargeGas = true, isSelfdestructOrAuthcall = false): bigint {
 ...
 */
export function adjustSstoreGasEIP2929(runState: RunState, key: Uint8Array, defaultCost: bigint, costName: string, common: Common): bigint {
    if (common.isActivatedEIP(2929) === false)
        return defaultCost;
    const address = runState.interpreter.getAddress().bytes;
