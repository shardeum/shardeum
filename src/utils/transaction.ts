...
export function getTxSenderAddress(tx: TypedTransaction, txid: string = undefined, overrideSender: Address = undefined): GetTxSenderAddressResult {
    try {
...
export function isStakingEVMTx(transaction: Transaction[TransactionType.Legacy] | Transaction[TransactionType.AccessListEIP2930]): boolean {
