...
import type { BuildBlockOpts, BuilderOpts, EIP4844BlobTxReceipt, PostByzantiumTxReceipt, PreByzantiumTxReceipt, RunTxResult, SealBlockOpts } from './types.js';
...
export class BlockBuilder {
     ...
     */
    async addTransaction(tx: TypedTransaction, { skipHardForkValidation }: {
