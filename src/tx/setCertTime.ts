...
import { AccountType, InternalTXType, NodeAccountQueryResponse, SetCertTime, WrappedEVMAccount, WrappedStates, InjectTxResponse, isNetworkAccount, } from '../shardeum/shardeumTypes';
