...
console.log('CONFIG FIRST: ', Utils.safeStringify(config))
...
console.log('CONFIG AFTER FILE: ', Utils.safeStringify(config))
...
console.log('CONFIG AFTER MERGE 1: ', Utils.safeStringify(config))
...
console.log('CONFIG AFTER MERGE 2 - BEFORE LOAD JSON CONFIGS: ', Utils.safeStringify(config))
...
console.log('CONFIG AFTER MERGE 3 - BEFORE LOAD BASE DIR CONFIGS: ', Utils.safeStringify(config))
...
console.log('CONFIG BEFORE LAST MERGE: ', Utils.safeStringify(config))
...
console.log('CONFIG FINAL: ', Utils.safeStringify(config))
