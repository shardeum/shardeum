...
import { configShardusEndpoints } from './endpoints'
...
export const ERC20_BALANCEOF_CODE = '0x70a08231'
...
export const ERC20TokenBalanceMap: {
  to: string
  data: unknown
  timestamp: number
  result: unknown
 ...
 */
export async function accountMissNoOp(): Promise<boolean> {
  const isRemoteShard = false
  return isRemoteShard
}

export async function contractStorageMissNoOp(): Promise<boolean> {
  const isRemoteShard = false
  return isRemoteShard
}

export function accountInvolvedNoOp(): boolean {
  return true
}

export function contractStorageInvolvedNoOp(): boolean {
  return true
}
...
export function monitorEventCBNoOp(): void {
  // no op
}

export async function tryGetRemoteAccountCB(
...
export async function _internalHackPostWithResp(url: string, body: ShardusTypes.OpaqueTransaction): Promise<got.Response<unknown>> {
...
; (async (): Promise<void> => {
  ...
  shardus = configShardusEndpoints(shardus)
  shardusSetup()
...
export function getIsReadyToJoinLatestValue(): boolean {
  return isReadyToJoinLatestValue
}

export function getAdminCert(): AdminCert {
  return adminCert
}

export function setAdminCert(cert: AdminCert): void {
  adminCert = cert
}

export function getStakeCert(): StakeCert {
  return stakeCert
}

export function setStakeCert(cert: StakeCert): void {
  stakeCert = cert
}
...
export function getShardeumStateTXMap(): Map<string, ShardeumState> {
  return shardeumStateTXMap
}

export function getShardusAddressToEVMAccountInfo(): Map<string, EVMAccountInfo> {
  return shardusAddressToEVMAccountInfo
}
