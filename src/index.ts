...
export const createInternalTxReceipt = (
  ...
  const readableReceipt: ReadableReceipt = {
    ...
    gasUsed: '0x0',
    gasRefund: '0x0',
    //gasPrice: internalTx.accountData.readableReceipt.gasPrice,
    //gasLimit: internalTx.accountData.readableReceipt.gasLimit,
    ...
    data: '0x0',
    //type: '0x1',
    //chainId: ShardeumFlags.ChainID.toString(),
    isInternalTx: true,
    internalTx: { ...internalTx, sign: null },
    //accessList: [],
    //v: internalTx.accountData.readableReceipt.v,
    //r: internalTx.accountData.readableReceipt.r,
    //s: internalTx.accountData.readableReceipt.s,
  }
...
const shardusSetup = (): void => {
  ...
  shardus.setup({
    ...
    async getAccountDataByRange(
      ...
      shardus.log(
        `getAccountDataByRange: extra:${extra} ${stringify({
          accountStart,
          accountEnd,
          tsStart,
          tsEnd,
    ...
    getSimpleTxDebugValue(timestampedTx) {
      ...
      try {
        ...
        //@ts-ignore
        const { tx } = timestampedTx
        console.log(`getSimpleTxDebugValue failed: ${stringify(e)}  tx:${stringify(tx)}`)
      }
    },
    ...
    async isReadyToJoin(
      ...
      console.log(
        `active: ${latestCycle.active}, syncing: ${latestCycle.syncing}, flag: ${ShardeumFlags.AdminCertEnabled}`
      )
      ...
      if (stakeCert != null) {
        ...
        if (ShardeumFlags.VerboseLogs) {
          /* prettier-ignore */ console.log(`cert != null, remainingValidTime: ${remainingValidTime}, expiredPercentage: ${expiredPercentage}, isExpiringSoon: ${isExpiringSoon}`)
        }
        if (isExpiringSoon) {
