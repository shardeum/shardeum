...
- `src/tx/changeConfig/validate.ts`: Core validation functions and integration with transaction validation
- `test/unit/src/tx/changeConfig/validate.test.ts`: Unit and integration tests
